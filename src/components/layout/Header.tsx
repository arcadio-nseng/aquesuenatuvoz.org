            ...
            <div className="px-8 mx-auto max-w-7xl">
                <div className="flex items-center justify-between h-16">
                    <div className="w-full justify-between flex items-center">
                        <a className="flex-shrink-0 flex flex-row items-center" href="/">
                            <Image className="w-8 h-8" src={Logo70} alt="Logotipo de A qué suena tu voz"/>
                            <h1 className="text-gray-50 font-bold ml-1">A qué Suena tu Voz</h1>
                        </a>
